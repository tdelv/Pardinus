...
//		final SATSolver satSolver = SATFactory.Lingeling.instance();
//		satSolver.addVariables(1);
//		satSolver.addClause(new int[]{1});
//		assertTrue(satSolver.solve());
//		satSolver.addVariables(1);
//		satSolver.addClause(new int[]{-2});
//		assertTrue(satSolver.solve());
//		satSolver.addVariables(8);
//		satSolver.addClause(new int[]{2, 9, 10});
//		assertTrue(satSolver.solve());
//		satSolver.addClause(new int[0]);
//		satSolver.addClause(new int[]{7, 8, 10});
//		assertFalse(satSolver.solve());
//		satSolver.addClause(new int[]{-3, 5});
//		assertFalse(satSolver.solve());
//	}
//
//	@Test
