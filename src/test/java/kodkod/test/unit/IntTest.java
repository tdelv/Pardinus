...
//		  System.out.println(bounds);
	...
	/**
	 * Tests all binary ops for this.satSolver.options and range of vals.
	 * @requires this.satSolver.options.intEncoding = binary
	 * @requires vals contains int expressions that represent all
	 * integers allowed by this.satSolver.options, in proper sequence
	 */
	...
	/**
	 * Tests all comparison ops for this.satSolver.options and range of vals.
	 * @requires this.satSolver.options.intEncoding = binary
	 * @requires vals contains int expressions that represent all
	 * integers allowed by this.satSolver.options, in proper sequence
	 */
